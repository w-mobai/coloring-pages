    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <DialogPrimitive.Content
          ...
          className={cn(
            "bg-background relative grid w-full max-w-[calc(100%-2rem)] gap-4 rounded-lg border p-6 shadow-lg outline-none focus:outline-none transition-opacity duration-200 data-[state=closed]:opacity-0 data-[state=open]:opacity-100 sm:max-w-lg",
            className
          )}
          {...props}
        >
