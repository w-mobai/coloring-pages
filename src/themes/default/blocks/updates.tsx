              ...
              <div key={post.url} className="relative">
                <div className="flex flex-col gap-y-6 md:flex-row">
                  ...
                  <div className="relative flex-1 pb-10 md:pl-8">
                    ...
                    <div className="bg-border absolute top-2 left-0 hidden h-full w-px -translate-x-1/2 md:block">
                      {/* Timeline dot */}
                      <div className="bg-primary absolute top-0 left-0 z-10 hidden size-3 -translate-x-1/2 rounded-full md:block" />
                    </div>
